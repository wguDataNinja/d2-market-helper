...
CAVEATS = [
    ...
    "Current model uses only single-rune Ist-pair trades from completed listings.",
    "AND trades (multi-item requests) are excluded from this model.",
    ...
    product_v2 = {
        ...
        "model": {
            ...
            "excludes": [
                ...
                "AND trades (multi-item requests)",
